...
export default class EditContact extends React.Component{
    ...
    componentDidMount() {
        axios.get("http://localhost:5000/edit/"+this.props.match.params.contact)
            .then(res => {
                this.setState({
                    name: res.data.name,
    ...
    onSubmit(e) {
        ...
        axios.put("http://localhost:5000/edit/"+this.props.match.params.contact, contact)
        ...
        return (
            <div>
                ...
                <form onSubmit={this.onSubmit}>
                    ...
                    <div className="form-group">
                        <input type="submit" className="btn btn-primary" value="Confirm changes" onChange={this.onSubmit} />
                    </div>
                </form>
            </div>
        )
